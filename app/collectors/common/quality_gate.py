...
#
# フォローバック狙い・出会い系・稼げる系スパムに加え、2026-07-08「品質ゲートの
# 厳格化」対応で「ビジネス運用ではない個人の趣味/日常アカウント」であることを
# 示す典型的なワードも追加した（モデリング対象は再現性のあるビジネスアカウント
# であるべきという前提のため）。「初心者」等はニッチの説明（例:
# 「英会話初心者向けアカウント」）で使われる可能性もあり誤検知リスクはあるが、
# 依頼に基づき採用した。
DEFAULT_SPAM_KEYWORDS = (
    "相互フォロー", "フォロバ100", "フォロバ最速", "全フォロバ", "即フォロバ",
    "副業で稼", "在宅で稼", "簡単に稼", "権利収入", "不労所得", "月収",
    "line@", "LINE@", "出会い系", "エロ動画", "アダルト動画", "裏垢",
    # 個人の趣味/日常アカウントを示す典型ワード
    "日常垢", "趣味垢", "雑談垢", "自分用メモ", "備忘録", "低浮上", "サブ垢",
    "裏アカ", "初心者", "馴れ合い", "推し活",
    "hobby account", "personal use only", "just for fun",
)
